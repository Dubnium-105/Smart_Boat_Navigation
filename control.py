...
class IRControlApp:
    def __init__(self):
        ...
        # 传感器数据
        self.ir_sensor_status = [False] * 16
        ...
        self.ir_vectors = [
            ...
            (0.3827, 0.9239),  # 67.5度
            (0.0, 1.0),        # 90度
            (-0.3827, 0.9239), # 112.5度
            (-0.7071, 0.7071), # 135度
            (-0.9239, 0.3827), # 157.5度
            (-1.0, 0.0),       # 180度
            (-0.9239, -0.3827),# 202.5度
            (-0.7071, -0.7071),# 225度
            (-0.3827, -0.9239),# 247.5度
            (0.0, -1.0),       # 270度
            (0.3827, -0.9239), # 292.5度
            (0.7071, -0.7071), # 315度
            (0.9239, -0.3827)  # 337.5度
        ]
